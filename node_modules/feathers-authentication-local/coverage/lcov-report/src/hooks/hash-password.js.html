...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import hasher from '../utils/hash';
...
&nbsp;
    const app = hook.app;
    c</span>onst authOptions = app.get('authentication') || <span class="branch-1 cbranch-no" title="branch not covered" >{};
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof field !== 'string') {
<span class="cstat-no" title="statement not covered" >      return Promise.reject(new Error(`You must provide a 'passwordField' in your authentication configuration or pass one explicitly`));</span>
    }
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Jun 22 2017 08:47:00 GMT-0600 (MDT)
</div>
</div>
